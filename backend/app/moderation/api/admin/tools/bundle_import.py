"""Bundle import endpoint scaffolding."""
...
@router.post("/run/bundle_import", response_model=JobHandle, status_code=status.HTTP_202_ACCEPTED)
async def import_bundle(
    ...
    try:
        return await executor.import_bundle(payload, actor_id=auth_user.id)
