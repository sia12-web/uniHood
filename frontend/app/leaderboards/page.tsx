...
export default function LeaderboardsPage() {
  ...
  // Fetch Leaderboard - always use "overall" scope which combines all social activities
  useEffect(() => {
    ...
    <main className="mx-auto flex max-w-4xl flex-col gap-8 p-6">
      ...
      <div className="flex items-center justify-center gap-4 rounded-2xl bg-gradient-to-r from-rose-50 to-amber-50 p-6 border border-rose-100">
        ...
        <div className="text-left">
          ...
          <p className="text-sm text-slate-600">Friends + Meetups + Games combined</p>
        </div>
      </div>
      ...
      <div className="rounded-2xl border border-slate-200 bg-white p-6">
        <h3 className="mb-4 text-sm font-bold uppercase tracking-widest text-slate-500">How Points Are Earned</h3>
        <div className="grid gap-4 sm:grid-cols-3">
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="font-semibold text-slate-900">Games</p>
              <p className="text-xs text-slate-500">+50 per game, +150 per win</p>
            </div>
          </div>
        </div>
