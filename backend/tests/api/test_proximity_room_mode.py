"""Tests for proximity radius filtering in Room mode (100m)."""
...
async def test_room_mode_filters_by_100m_radius(monkeypatch, api_client):
	...
	response = await api_client.get(
		"/proximity/nearby",
		params={"campus_id": campus_id, "radius_m": 100, "scope": "campus"},
